...
| Prediction service | Coordinates local lookup, external requests, feature construction, and model inference. | [`flight_prediction_service.py`](../backend/services/flight_prediction_service.py) |
